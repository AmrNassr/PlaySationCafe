...
public class addsupplier extends javax.swing.JFrame {
    ...
    public addsupplier() throws ParseException {
        initComponents();
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
         ...
         String namee = name.getText();
            ...
            {
                JOptionPane.showMessageDialog(this, " من فضلك ادخل اسم المورد");
            }
            else
            {
                ...
                if(dialogResult == 0) {
                    try{
                        String sql = "INSERT INTO cafe.storesupplier (name) VALUES ('"+namee+"')";
                        pst = (PreparedStatement)DBConnect.con.prepareStatement(sql);
                        pst.execute();
                        JOptionPane.showMessageDialog(null, "تم اضافه المورد بنجاح");
                        name.setText("");
                        
                    }
                    catch(Exception e ){
                        JOptionPane.showMessageDialog(null,"المورد موجود من قبل");
                    }
