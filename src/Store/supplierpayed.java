...
public class supplierpayed extends javax.swing.JFrame {
         ...
         || dayy == 5 || dayy == 6 || dayy == 7 || dayy == 8 || dayy == 9 )
 {
    ...
    private void initComponents() {
        ...
        jLabel13.setText("المورد");
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 20, 180, -1));

        cmtype.setEditable(true);
        cmtype.setModel(new javax.swing.DefaultComboBoxModel(new String[] { " " }));
        jPanel1.add(cmtype, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 260, 30));
    ...
    String typee=cmtype.getSelectedItem().toString();
     InputStream in=null;
      try {
          ...
          in = this.getClass().getResourceAsStream("/reports/supplierpayedbysupplier.jasper");
          String reportpath= "\\\\192.168.1.15\\sadam\\msrofatType.jasper";
...
public void msroffat()
   {
        try {
             String sql="SELECT name  FROM cafe.storecompany ";
