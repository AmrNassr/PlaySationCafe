...
public class supplieramountdetails extends javax.swing.JFrame {
    ...
    String to=year2.getText()+"-"+month2.getText()+"-"+day2.getText();
     InputStream in=null;
      try {
          ...
          in = this.getClass().getResourceAsStream("/reports/supplierpay.jasper");
          String reportpath= "\\\\192.168.1.15\\sadam\\supplierpay.jasper";
