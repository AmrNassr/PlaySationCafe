...
public class storebuyreport extends javax.swing.JFrame {
    ...
    String to=year2.getText()+"-"+month2.getText()+"-"+day2.getText();
     InputStream in=null;
      try {
          ...
          in = this.getClass().getResourceAsStream("/reports/storebuy.jasper");
