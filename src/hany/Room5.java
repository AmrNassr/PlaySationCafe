...
public class Room5 extends javax.swing.JFrame {
    ...
    public Room5() throws IOException, ParseException {
        try {
            initComponents();
            ...
            playstationtype();
            auto_id();
            String sqldd = "SELECT total FROM cafe.roomitems where date='" + datee + "' and buyserial='" + serialbuy.getText() + "' and room='Room5'";
            ...
            Logger.getLogger(Room5.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (dialogResult == 0) {
            markroom = "Yes";
            people.fulltime5.setText("00" + " : " + "00" + " : " + "00" + " : " + "00");
            this.dispose();
        } else {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            if (Integer.parseInt(number.getText()) < Integer.parseInt(available.getText())) {
                ...
                + "'" + total + "','" + datee + "','" + fulldatee + "','" + seriall + "','Room5')";
                pst = (PreparedStatement) DBConnect.con.prepareStatement(sql);
                pst.execute();
    ...
    private void resetMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_resetMousePressed
        ...
        if (open.isSelected()) {
            ...
            people.fulltime5.setText(hour1.getText() + " : " + min.getText() + " : " + sec.getText() + " : " + msec.getText());
        } else {
            String hourpeice;
    ...
    private void startMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_startMousePressed
        ...
        if ((gameprice.getText().trim().isEmpty() && gamepricedouble.getText().trim().isEmpty())
            ...
            p4.setVisible(false);
            reset.setVisible(true);
            people.fulltimepanel5.setBackground(new Color(204, 255, 255));
            isStart = true;
            if (single.isSelected()) {
                hourpeice = gameprice.getText();
            } else {
                        ...
                        public void run() {
                            ...
                            while (isStart == true && csecond > 0) {
                                ...
                                if (second == 0 && minute == 0 && hour == 0 && music.equals("No")) {
                                    ...
                                    mp3.play();
                                    new NoticeWindow(NoticeType.ERROR_NOTIFICATION, " Room 5  Time Finished", NoticeWindow.LONG_DELAY, NPosition.BOTTOM_RIGHT);
                                    music = "yes";
                                    people.fulltimepanel5.setBackground(Color.red);
                        ...
                        public void run() {
                            ...
                            while (isStart == true && csecond > 0) {
                                ...
                                if (second == 0 && minute == 0 && hour == 0 && music.equals("No")) {
                                    ...
                                    mp3 = new MP3Player(new File(path));
                                    mp3.play();
                                    JOptionPane.showMessageDialog(rootPane, "Room 5  Time Finished");
                                    music = "yes";
                                    people.fulltimepanel5.setBackground(Color.red);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (timee.isSelected()) {
            try {
                ...
                + "'" + kshmm + "','" + totalx + "','" + billtotal.getText() + "','" + billtotalcafe.getText() + "','Room 5','" + serialbuy.getText() + "')";
                pst = (PreparedStatement) DBConnect.con.prepareStatement(sql);
                pst.execute();
                ...
                + "'" + billtotal.getText() + "','" + datee + "','" + fulldatee + "','" + serialbuy.getText() + "','Room5')";
                pst = (PreparedStatement) DBConnect.con.prepareStatement(sqll);
                pst.execute();
                JOptionPane.showMessageDialog(rootPane, " تم تقفيل الحساب " + totalx);
                people.fulltime5.setText("00" + " : " + "00" + " : " + "00" + " : " + "00");
                markroom = "Yes";
                people.fulltimepanel5.setBackground(new Color(204, 204, 204));
                InputStream in = null;
                try {
            ...
            try {
                ...
                + "'" + kshmm + "','" + totalx + "','" + totalbilltotal + "','" + billtotalcafe.getText() + "','Room 5','" + serialbuy.getText() + "')";
                pst = (PreparedStatement) DBConnect.con.prepareStatement(sql);
                pst.execute();
                String sqll = "INSERT INTO cafe.roomitems (item,number,price,total,date,fulldate,buyserial,room) VALUES"
                + " ('" + gametypee + "','" + totalroomhour1 + "','" + hourpeice + "',"
    ...
    public void tablelord() {
        try {
            String sqll = "SELECT * FROM cafe.roomitems where buyserial='" + serialbuy.getText() + "' and date='" + datee + "' and room ='Room5' order by id";
            pst = (PreparedStatement) DBConnect.con.prepareStatement(sqll);
            rs = pst.executeQuery();
    ...
    public void auto_id() {
        ...
        try {
            String sqll = "SELECT Distinct buyserial FROM cafe.room where buyserial like 'R5%'  order by id DESC limit 1";
            pst = (PreparedStatement) DBConnect.con.prepareStatement(sqll);
            rs = pst.executeQuery();
            if (rs.next()) {
