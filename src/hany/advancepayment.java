...
headerLabel.setHorizontalAlignment(JLabel.CENTER);
    ...
    private void initComponents() {
        ...
        jPanel10.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 320, 970, 280));
        ...
        jPanel10.add(delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 240, 180, 50));
        ...
        jPanel10.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 0, 1080, 720));
...
String amount = advanceamount.getText();
  String name = cmname.getSelectedItem().toString();
   ...
   // else
    ...
    {
            try{
                String sql = "SELECT MIN(remaining) as remaining FROM cafe.advanceamount where serial='"+serial+"' AND date between '"+curr+"' AND '"+end+"'";
             ...
             if(rs.next()){
                 ...
                 int remaining = remain - x;
                  String sql111 = "INSERT INTO cafe.advanceamount (name,serial,amount,remaining,date) VALUES "
                          + " ('"+name+"','"+serial+"','"+amount+"','"+remaining+"','"+date.getText()+"')";
                        pst = (PreparedStatement)DBConnect.con.prepareStatement(sql111);
                        pst.execute();
             ...
             {
                 String sqll = "SELECT salary FROM cafe.employee where serial='"+serial+"'";
             ...
             if(rs.next()){
                 ...
                 int remain = remianing-x;
                  String sql1 = "INSERT INTO cafe.advanceamount (name,serial,amount,remaining,date) VALUES "
   ...
   public void tablelord()
    {
        try {
            String sqll = "SELECT serial,name,amount,remaining,date FROM cafe.advanceamount  ORDER BY serial ASC,\n" +
"    remaining DESC;";
              pst=(PreparedStatement) DBConnect.con.prepareStatement(sqll);
            rs=pst.executeQuery();
 ...
 serialid.setText("");
   ...
   public void comboxfromcombo()
      {
            ...
            public void itemStateChanged(ItemEvent event) {
                ...
                Object item = event.getItem();
                     try {
             String sql="SELECT name  FROM cafe.employee where serial='"+cmserial.getSelectedItem().toString()+"'";
             pst=(PreparedStatement) DBConnect.con.prepareStatement(sql);
             rs=pst.executeQuery();
             if(rs.next()){
                ...
                if (event.getStateChange() == ItemEvent.DESELECTED) {
                 ...
                 try {
             String sql="SELECT MIN(remaining)as remaining  FROM cafe.advanceamount where serial='"+cmserial.getSelectedItem().toString()+"' and date between '"+curr+"' AND '"+end+"'";
               pst=(PreparedStatement) DBConnect.con.prepareStatement(sql);
               rs=pst.executeQuery();
               if(rs.next()){
                   if(rs.getString("remaining") != null && rs.getString("remaining").trim().length() > 0){
                       amount.setText(rs.getString("remaining"));
                        ...
                        String sql9="SELECT salary  FROM cafe.employee where serial='"+cmserial.getSelectedItem().toString()+"'";
               pst=(PreparedStatement) DBConnect.con.prepareStatement(sql9);
               rs=pst.executeQuery();
                   if(rs.next()){
   ...
   {
        try {
             String sql="SELECT serial  FROM cafe.employee order by CONVERT(replace(serial,'EM',''),UNSIGNED INTEGER) ASC ";
             pst=(PreparedStatement) DBConnect.con.prepareStatement(sql);
             rs=pst.executeQuery();
             while(rs.next()){
   ...
   {
        try {
             String sql="SELECT name  FROM cafe.employee ";
             pst=(PreparedStatement) DBConnect.con.prepareStatement(sql);
             rs=pst.executeQuery();
             while(rs.next()){
