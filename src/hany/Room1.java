...
public class Room1 extends javax.swing.JFrame {
    ...
    public Room1() throws IOException, ParseException {
        try {
            initComponents();
            ...
            playstationtype();
            auto_id();
            String sqldd = "SELECT total FROM cafe.roomitems where date='" + datee + "' and buyserial='" + serialbuy.getText() + "' and room='Room1'";
    ...
    private void startMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_startMousePressed
        ...
        if ((gameprice.getText().trim().isEmpty() && gamepricedouble.getText().trim().isEmpty())
            ...
            people.fulltimepanel1.setBackground(new Color(204, 255, 255));
            isStart = true;
                    ...
                    public void run() {
                        while (isStart == true) {
                            try {
                                ...
                                people.fulltime1.setText(hour1.getText() + " : " + min.getText() + " : " + sec.getText() + " : " + msec.getText());
                            } catch (Exception ex) {
                        ...
                        public void run() {
                            ...
                            while (isStart == true && csecond > 0) {
                                ...
                                if (second == 0 && minute == 0 && hour == 0 && music.equals("No")) {
                                    ...
                                    mp3.play();
                                    new NoticeWindow(NoticeType.ERROR_NOTIFICATION, " Room 1  Time Finished", NoticeWindow.LONG_DELAY, NPosition.BOTTOM_RIGHT);
                                    music = "yes";
                                    people.fulltimepanel1.setBackground(Color.red);
                        ...
                        public void run() {
                            ...
                            while (isStart == true && csecond > 0) {
                                ...
                                if (second == 0 && minute == 0 && hour == 0 && music.equals("No")) {
                                    ...
                                    mp3 = new MP3Player(new File(path));
                                    mp3.play();
                                    JOptionPane.showMessageDialog(rootPane, "Room 1  Time Finished");
                                    music = "yes";
                                    people.fulltimepanel1.setBackground(Color.red);
        ...
        if (timee.isSelected()) {
            try {
                ...
                String sql = "INSERT INTO cafe.room (gametype,timee,type,date,fulldate,timetype,kshm,total,totalplay,totalitem,roomnumber,buyserial) VALUES"
                        ...
                        + "'" + kshmm + "','" + totalx + "','" + billtotal.getText() + "','" + billtotalcafe.getText() + "','Room 1','" + serialbuy.getText() + "')";
                ...
                String sqll = "INSERT INTO cafe.roomitems (item,number,price,total,date,fulldate,buyserial,room) VALUES"
                        ...
                        + "'" + billtotal.getText() + "','" + datee + "','" + fulldatee + "','" + serialbuy.getText() + "','Room1')";
                pst = (PreparedStatement) DBConnect.con.prepareStatement(sqll);
                pst.execute();
                JOptionPane.showMessageDialog(rootPane, " تم تقفيل الحساب " + totalx);
                people.fulltime1.setText("00" + " : " + "00" + " : " + "00" + " : " + "00");
                markroom = "Yes";
                people.fulltimepanel1.setBackground(new Color(204, 204, 204));
                InputStream in = null;
                try {
            ...
            try {
                ...
                String sql = "INSERT INTO cafe.room (gametype,timee,type,date,fulldate,timetype,kshm,total,totalplay,totalitem,roomnumber,buyserial) VALUES"
                        ...
                        + "'" + kshmm + "','" + totalx + "','" + totalbilltotal + "','" + billtotalcafe.getText() + "','Room 1','" + serialbuy.getText() + "')";
                pst = (PreparedStatement) DBConnect.con.prepareStatement(sql);
                pst.execute();
                String sqll = "INSERT INTO cafe.roomitems (item,number,price,total,date,fulldate,buyserial,room) VALUES"
                        + " ('" + gametypee + "','" + totalroomhour1 + "','" + hourpeice + "',"
        ...
        try {
            if (Integer.parseInt(number.getText()) < Integer.parseInt(available.getText())) {
                String sql = "INSERT INTO cafe.roomitems (item,number,price,total,date,fulldate,buyserial,room) VALUES"
                        ...
                        + "'" + total + "','" + datee + "','" + fulldatee + "','" + seriall + "','Room1')";
                pst = (PreparedStatement) DBConnect.con.prepareStatement(sql);
                pst.execute();
    ...
    public void tablelord() {
        try {
            String sqll = "SELECT * FROM cafe.roomitems where buyserial='" + serialbuy.getText() + "' and date='" + datee + "' and room ='Room1' order by id";
            pst = (PreparedStatement) DBConnect.con.prepareStatement(sqll);
            rs = pst.executeQuery();
    ...
    public void auto_id() {
        ...
        try {
            String sqll = "SELECT Distinct buyserial FROM cafe.room where buyserial like 'R1%'  order by id DESC limit 1";
            pst = (PreparedStatement) DBConnect.con.prepareStatement(sqll);
            rs = pst.executeQuery();
            if (rs.next()) {
