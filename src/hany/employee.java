...
headerLabel.setHorizontalAlignment(JLabel.CENTER);
        ...
        tdetails.getTableHeader().setBackground(new Color(21,31,41));
    ...
    private void initComponents() {
        ...
        jPanel10.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 260, 970, 280));
        ...
        jPanel10.add(delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 560, 180, 50));
        ...
        cmtype.setModel(new javax.swing.DefaultComboBoxModel(new String[] { " ", "بائع", "خدمة عملاء", "محاسب", "مدخل بيانات", "محصل" }));
        ...
        jPanel10.add(save, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 170, 180, 40));
        ...
        jPanel10.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 0, 1070, 720));
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        if(serialid.getText().trim().isEmpty())
        {
            ...
            else
            {
                ...
                if(dialogResult == 0) {
                    try{
                        String sql = "INSERT INTO cafe.employee (name,phone,type, salary,serial) VALUES"
            ...
            int dialogButton = JOptionPane.YES_NO_OPTION;
                ...
                if(dialogResult == 0) {
                 try {
                    ...
                    String sql = "UPDATE cafe.employee SET type='"+typee+"',salary='"+salaryy+"', name='"+namee+"',  phone='"+phonee+"'  WHERE serial='"+serialid.getText()+"'";
                    pst=(PreparedStatement) DBConnect.con.prepareStatement(sql);
                    pst.executeUpdate();
...
JOptionPane.showMessageDialog(this, ex);
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        if(serialid.getText().trim().isEmpty())
        {
            ...
            if(dialogResult == 0) {
                try {
                    String sql = "DELETE FROM cafe.employee WHERE serial='"+serialid.getText()+"'";
                    pst=(PreparedStatement) DBConnect.con.prepareStatement(sql);
                    pst.execute();
   ...
   public void tablelord()
    {
        try {
            String sqll = "SELECT serial,name,type,phone,salary FROM cafe.employee";
 ...
 serialid.setText("");
       ...
       public void auto_id(){
         ...
         try {
             String sql = "SELECT serial FROM cafe.employee ORDER BY serial DESC LIMIT 1";
             pst=(PreparedStatement) DBConnect.con.prepareStatement(sql);
             rs=pst.executeQuery();
             if(rs.next()){
